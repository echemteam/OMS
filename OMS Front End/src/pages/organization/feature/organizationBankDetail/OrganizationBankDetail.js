...
const OrganizationBankDetail = (isEditablePage) => {
  ...
  const [organizationBankData, setOrganizationBankData] = useState(
    OrganizationBankFormData
  );
  const [
    addEditOrganizationBankDetails,
    {
      isLoading: isAddEditOrganizationBankDetailsLoading,
      isSuccess: isAddEditOrganizationBankDetailsSuccess,
      data: isAddEditOrganizationBankDetailsData,
    },
  ] = useAddEditOrganizationBankDetailsMutation();
  const [
    getOrganizationBankDetails,
    {
      isFetching: isGetOrganizationBankDetailsFetching,
      isSuccess: isGetOrganizationBankDetailsSuccess,
      data: isGetOrganizationBankDetailsData,
    },
  ] = useLazyGetOrganizationBankDetailsQuery();
  ...
  useEffect(() => {
    if (
      ...
      isAddEditOrganizationBankDetailsData
    ) {
  ...
  useEffect(() => {
    if (
      !isGetOrganizationBankDetailsFetching &&
      isGetOrganizationBankDetailsSuccess &&
      ...
      setBankDetailId(
        isGetOrganizationBankDetailsData.organizationBankDetailId
      );
    }
  }, [
    isGetOrganizationBankDetailsFetching,
  ...
  return (
    <div className="row mt-2 add-address-form">
      ...
      <div className="col-12">
        <FormCreator config={organizationBankData} ref={organizationBankRef} />
      </div>
      {isEditablePage ? (
