...
const OrganizationLogisticDetail = (isEditablePage) => {
  ...
  const [organizationLogisticData, setOrganizationLogisticData] = useState(
    OrganizationLogisticFormData
  );
  const [
    addEditOrganizationLogisticDetails,
    {
      isLoading: isAddEditOrganizationLogisticDetailsLoading,
      isSuccess: isAddEditOrganizationLogisticDetailsSuccess,
      data: isAddEditOrganizationLogisticDetailsData,
    },
  ] = useAddEditOrganizationLogisticDetailsMutation();
  const [
    getOrganizationLogisticDetails,
    {
      ...
      isSuccess: isGetOrganizationLogisticDetailsSuccess,
      data: isGetOrganizationLogisticDetailsData,
    },
  ] = useLazyGetOrganizationLogisticDetailsQuery();
  ...
  useEffect(() => {
    if (
      isAddEditOrganizationLogisticDetailsSuccess &&
      isAddEditOrganizationLogisticDetailsData
    ) {
      ToastService.success(
        isAddEditOrganizationLogisticDetailsData.errorMessage
      );
      getOrganizationLogisticDetails();
    }
  }, [
  ...
  useEffect(() => {
    if (
      !isGetOrganizationLogisticDetailsFetching &&
      isGetOrganizationLogisticDetailsSuccess &&
      isGetOrganizationLogisticDetailsData
    ) {
      let formData = { ...organizationLogisticData };
      formData.initialState = {
        organizationLogisticDetailId:
          isGetOrganizationLogisticDetailsData.organizationLogisticDetailId,
  ...
  return (
    <div className="row mt-2 add-address-form">
      ...
      <div className="col-12">
        <FormCreator
          config={organizationLogisticData}
