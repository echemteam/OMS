...
const ContactPhoneNumberDropdown = ({ showPhoneDropdown, setShowPhoneDropdown, primaryPhoneNumber, phoneNumbers }) => {
    ...
    return (
        <React.Fragment>
            <div className="label-txt d-flex align-items-center contact-sec">
                <Image imgCustomClassName="contact-icon-img" imagePath={AppIcons.ContactNo} altText="contact icon" />
                        ...
                        {primaryPhoneNumber ?
                            <div className="d-flex align-items-center">
                                ...
                                {primaryPhoneNumber?.isPrimary ? (
                                    <div className="primary-icon" title="Is Primary" ></div>) : null}
