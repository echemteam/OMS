...
//** Service's */
import {
  useAddSupplierNotesMutation,
  useLazyGetSupplierNotesBySupplierIdQuery,
  useUpdateSupplierNotesMutation,
} from "../../../../app/services/supplierNotesAPI";
//** Component's */
const NoteGrid = React.lazy(() =>
  import("../../../../common/features/component/Note/NoteGrid")
);
  ...
  return (
    ...
    <div className="supplier-note">
      <NoteGrid
        ...
        isSupplier={true}
        onAddNotes={useAddSupplierNotesMutation}
        onUpdateNotes={useUpdateSupplierNotesMutation}
        onGetByIdNotes={useLazyGetSupplierNotesBySupplierIdQuery}
      />
    </div>
  );
};
