...
/****** Object:  Trigger [dbo].[trg_AfterUpdate_Addresses]    Script Date: 28-06-2024 18:12:32 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Trigger [dbo].[trgContacts_Update]    Script Date: 28-06-2024 18:12:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_CustomerAccoutingSettings]    Script Date: 28-06-2024 18:12:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_CustomerAccoutingSettings]    Script Date: 28-06-2024 18:12:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_CustomerDocuments]    Script Date: 28-06-2024 18:12:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_Customers]    Script Date: 28-06-2024 18:12:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_Customers]    Script Date: 28-06-2024 18:12:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
        ...
        CONCAT(
            ...
            STUFF((
                SELECT 
                    ...
                    CASE WHEN i.IsCompany <> d.IsCompany THEN ', IsCompany' ELSE '' END +
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_Emails]    Script Date: 28-06-2024 18:12:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_Emails]    Script Date: 28-06-2024 18:12:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_L_CustomCharge_CustomerDeliveryMethods]    Script Date: 28-06-2024 18:12:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_L_CustomCharge_CustomerDeliveryMethods]    Script Date: 28-06-2024 18:12:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_Address]    Script Date: 28-06-2024 18:12:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_L_CustomerAddresses]    Script Date: 28-06-2024 18:12:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_L_CustomerContacts]    Script Date: 28-06-2024 18:12:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trgCustomerContacts_Update]    Script Date: 28-06-2024 18:12:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    SELECT
        ...
        CONCAT(
            ...
            CASE WHEN i.IsPrimary <> d.IsPrimary THEN 'IsPrimary, ' ELSE '' END +
            CASE WHEN i.StatusId <> d.StatusId THEN 'StatusId, ' ELSE '' END +
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_L_CustomerDeliveryCarriers]    Script Date: 28-06-2024 18:12:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_L_CustomerDeliveryCarriers]    Script Date: 28-06-2024 18:12:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    SELECT
        ...
        CONCAT(
            ...
            STUFF((
                SELECT 
                    CASE WHEN i.CarrierId <> d.CarrierId THEN ', CarrierId' ELSE '' END +
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_SupplierAddress]    Script Date: 28-06-2024 18:12:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_L_SupplierAddresses]    Script Date: 28-06-2024 18:12:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_L_SupplierContacts]    Script Date: 28-06-2024 18:12:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trgCustomerContacts_L_SupplierContacts]    Script Date: 28-06-2024 18:12:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_Phones]    Script Date: 28-06-2024 18:12:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_Phones]    Script Date: 28-06-2024 18:12:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_SupplierAccoutingSettings]    Script Date: 28-06-2024 18:12:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_SupplierAccoutingSettings]    Script Date: 28-06-2024 18:12:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_SupplierDocuments]    Script Date: 28-06-2024 18:12:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterInsert_Suppliers]    Script Date: 28-06-2024 18:12:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_AfterUpdate_Suppliers]    Script Date: 28-06-2024 18:12:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
